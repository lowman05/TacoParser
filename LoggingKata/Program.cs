        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int j = 0; j < locations.Length; j++)
                {
                    ...
                    var corB = new GeoCoordinate() { Longitude = locB.Location.Longitude, Latitude = locB.Location.Latitude };
            ...
            Console.WriteLine($"{tacoBell1.Name} is furthest from {tacoBell2.Name}!");
